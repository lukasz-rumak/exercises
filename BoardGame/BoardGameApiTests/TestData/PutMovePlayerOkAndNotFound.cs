...
namespace BoardGameApiTests.TestData
{
    public class PutMovePlayerOkAndNotFound : IEnumerable<object[]>
    {
        ...
        {
            new object[]
                {Guid.Parse("c5665f24-93f5-4b55-81a0-8e245a9caecb"), new MovePlayer {PlayerId = 0, MoveTo = "MMMRRRRM"}, HttpStatusCode.OK, "The piece moved. PieceId: 0, PieceType: Pawn, new position: (0,4)"},
            new object[]
                {Guid.Parse("c5665f24-93f5-4b55-81a0-8e245a9caecb"), new MovePlayer {PlayerId = 0, MoveTo = "RMMMMLMM"}, HttpStatusCode.OK, "The piece moved. PieceId: 0, PieceType: Pawn, new position: (4,2)"},
            new object[]
