...
namespace BoardGameApiTests.TestData
{
    public class PutNewWallBadRequest : IEnumerable<object[]>
    {
        ...
        {
            new object[]
                {Guid.Parse("c5665f24-93f5-4b55-81a0-8e245a9caecb"), new Wall {WallCoordinates = "W 5 5 6 6"}, HttpStatusCode.BadRequest, new BadRequestErrors { Errors = new [] {"The wall was not created! Input wall position should fit into the board size"}}},
            new object[]
                {Guid.Parse("c5665f24-93f5-4b55-81a0-8e245a9caecb"), new Wall {WallCoordinates = "W 4 5 4 4"}, HttpStatusCode.BadRequest, new BadRequestErrors { Errors = new [] {"The wall was not created! Input wall position should fit into the board size"}}},
            new object[]
