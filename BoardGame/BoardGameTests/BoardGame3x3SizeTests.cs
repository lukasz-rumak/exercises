...
namespace BoardGameTests
{
    public class BoardGame3x3SizeTests
    {
        ...
        public BoardGame3x3SizeTests()
        {
            ...
            _game.RunBoardBuilder(new BoardBuilder(_game.ObjectFactory.Get<IEventHandler>(), _game.ObjectFactory.Get<IValidatorWall>(), _game.ObjectFactory.Get<IValidatorBerry>(), _game.ObjectFactory.Get<IBerryCreator>()).WithSize(3).BuildBoard());
        }
