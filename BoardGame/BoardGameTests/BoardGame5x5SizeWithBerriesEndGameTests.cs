    ...
    public class BoardGame5x5SizeWithBerriesEndGameTests
    {
        ...
        public BoardGame5x5SizeWithBerriesEndGameTests()
        {
            ...
            _game.RunBoardBuilder(new BoardBuilder(_game.ObjectFactory.Get<IEventHandler>(),
                ...
                .AddBerry("B 0 0").AddBerry("B 1 0").AddBerry("B 2 0").AddBerry("B 3 0").AddBerry("B 4 0")
                .AddBerry("B 1 1").AddBerry("B 2 1").AddBerry("B 3 1").AddBerry("B 4 1")
                .BuildBoard());
        }

        [Theory]
        [InlineData(new []{"PRMMMMLMMMMMM", "PRMMMMLMMMMMM"}, new []{"[P] 4 0 East [S] 4", "[P] 4 1 East [S] 3"})]
