    ...
    public class BoardGame5x5SizeWithBerriesTests
    {
        ...
        public BoardGame5x5SizeWithBerriesTests()
        {
            ...
            _game.RunBoardBuilder(new BoardBuilder(_game.ObjectFactory.Get<IEventHandler>(),
                    ...
                    _game.ObjectFactory.Get<IBerryCreator>(), _game.ObjectFactory.Get<IAStarPathFinder>()).WithSize(5)
        ...
        [Theory]
        [InlineData(new []{"PMMMMMM", "PMMMMMM"}, new []{"[P] 0 4 North [S] 5", "[P] 1 4 North [S] 3"})]
        [InlineData(new []{"PMMMMMM", "PRMMMMM"}, new []{"[P] 0 4 North [S] 5", "[P] 4 1 East [S] 4"})]
        ...
        [InlineData(new []{"PRMMMLMLMMMM", "PMRMMMLMMMLMMMMM"}, new []{"[P] 0 1 West [S] 9", "[P] 0 4 West [S] 2"})]
        [InlineData(new []{"PRMMMMLMMMMLMMMMM"}, new []{"[P] 0 4 West [S] 3"})]
        [InlineData(new []{"PRMMMMLMLMMMMRMRMMMMLMLMMMM"}, new []{"[P] 0 3 West [S] 18"})]
        ...
        [InlineData(new []{"PMXMMM", "PMRMLMRM"}, new []{"Instruction not clear. Exiting...", "[P] 3 3 East [S] 3"})]
