...
namespace BoardGameTests
{
    public class BerryValidatorTests
    {
        ...
        [Theory]
        [InlineData("B 1 1", 5, true, "")]
        [InlineData("B 3 4", 5, true, "")]
        [InlineData("B 3 2", 5, true, "")]
        [InlineData("B 4 4", 5, true, "")]
        [InlineData("B 26 29", 30, true, "")]
        [InlineData("B 29 30", 30, false, "Input wall position should fit into the board size")]
        [InlineData("B X 30", 30, false, "Input should have the following syntax: 'B 1 1'")]
        [InlineData("B 4 5", 5, false, "Input wall position should fit into the board size")]
        [InlineData("B1 1", 5, false, "Input should have the following syntax: 'B 1 1'")]
        [InlineData("B 1 12 2", 5, false, "Input should have the following syntax: 'B 1 1'")]
        [InlineData("B 1 X", 5, false, "Input should have the following syntax: 'B 1 1'")]
        [InlineData("B 1 !", 5, false, "Input should have the following syntax: 'B 1 1'")]
        [InlineData("B 2 aaa", 5, false, "Input should have the following syntax: 'B 1 1'")]
        [InlineData("B zxc 1", 5, false, "Input should have the following syntax: 'B 1 1'")]
        ...
        [InlineData("B 1X1 2", 5, false, "Input should have the following syntax: 'B 1 1'")]
        [InlineData("B 3 4 4", 5, false, "Input should have the following syntax: 'B 1 1'")]
        [InlineData("B 3 4 4 4 4", 5, false, "Input should have the following syntax: 'B 1 1'")]
        [InlineData(" B 3 4", 5, false, "Input should start with 'B'")]
        [InlineData("B 3 4 4 4 ", 5, false, "Input should have the following syntax: 'B 1 1'")]
        [InlineData(" B 3 4 4 4 ", 5, false, "Input should start with 'B'")]
        [InlineData("B1122", 5, false, "Input should have the following syntax: 'B 1 1'")]
        [InlineData("B -1 -1", 5, false, "Input should have the following syntax: 'B 1 1'")]
