...
namespace BoardGameTests
{
    public class BoardGame5x5SizeTests
    {
        ...
        [InlineData(new []{"MMMMMMMMMRMMMMMMM", "MMMMMMMMMRMMMMMMMM"}, new []{"4 4 East", "4 4 East"})]
        [InlineData(new []{"RMMMMMMMMMM"}, new []{"4 0 East"})]
        [InlineData(new []{"RMMMMMMMMMM", "RMMMMMMMMMMM"}, new []{"4 0 East", "4 0 East"})]
        ...
        [InlineData(new []{"MLMMM", "MLMMMM"}, new []{"0 1 West", "0 1 West"})]
        [InlineData(new []{"RMLMLMMMMM"}, new []{"0 1 West"})]
        [InlineData(new []{"RMLMLMMMMM", "RMLMLMMMMMM"}, new []{"0 1 West", "0 1 West"})]
