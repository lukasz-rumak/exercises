...
namespace BoardGameTests
{
    public class BoardGame5x5SizeWithWallsAndBerriesTests
    {
        ...
        [Theory]
        [InlineData(new []{"PMMMMMM", "PMMMMMM"}, new []{"[P] 0 3 North [S] 1", "[P] 1 1 North [S] 0"})]
        [InlineData(new []{"PMMMMMM", "PRMMMMM"}, new []{"[P] 0 3 North [S] 1", "[P] 4 1 East [S] 2"})]
        ...
        [InlineData(new []{"PRMMMLMLMMMM", "PMRMMMLMMMLMMMMM"}, new []{"[P] 0 1 West [S] 1", "[P] 4 4 West [S] 2"})]
        [InlineData(new []{"PRMMMMLMMMMLMMMMM"}, new []{"[P] 4 4 West [S] 1"})]
