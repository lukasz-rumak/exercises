    ...
    public class BoardGame5x5SizeWithWallsAndBerriesTests
    {
        ...
        public BoardGame5x5SizeWithWallsAndBerriesTests()
        {
            ...
            _game.RunBoardBuilder(new BoardBuilder(_game.ObjectFactory.Get<IEventHandler>(),
                ...
                .AddBerry("B 0 1").AddBerry("B 0 2").AddBerry("B 0 3").AddBerry("B 1 1").AddBerry("B 1 2")
        ...
        [InlineData(new []{"PMMMMMM", "PRMMMMM"}, new []{"[P] 0 3 North [S] 3", "[P] 4 1 East [S] 1"})]
        [InlineData(new []{"KMMMMM", "KMMMMM"}, new []{"[P] 0 0 NorthEast [S] 0", "[P] 2 2 NorthEast [S] 0"})]
        [InlineData(new []{"PRMMMLMLMMMM"}, new []{"[P] 0 1 West [S] 3"})]
        [InlineData(new []{"PRMMMLMLMMMM", "PMRMMMLMMMLMMMMM"}, new []{"[P] 0 1 West [S] 2", "[P] 4 4 West [S] 1"})]
        ...
        [InlineData(new []{"PMXMMM", "PMRMLMRM"}, new []{"Instruction not clear. Exiting...", "[P] 3 2 East [S] 1"})]
