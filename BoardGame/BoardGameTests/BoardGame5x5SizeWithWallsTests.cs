...
namespace BoardGameTests
{
    public class BoardGame5x5SizeWithWallsTests
    {
        ...
        public BoardGame5x5SizeWithWallsTests()
        {
            ...
            _game.RunBoardBuilder(new BoardBuilder(_game.ObjectFactory.Get<IEventHandler>(), _game.ObjectFactory.Get<IValidatorWall>(), _game.ObjectFactory.Get<IValidatorBerry>(), _game.ObjectFactory.Get<IBerryCreator>()).WithSize(5)
