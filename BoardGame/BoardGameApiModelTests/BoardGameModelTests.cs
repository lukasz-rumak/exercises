...
namespace BoardGameApiModelTests
{
    public class BoardGameModelTests
    {
        ...
        [Theory]
        [InlineData("B 0 0", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 1 1", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 2 2", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 12 12", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B X 30", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 8 X", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B1 1 2 2", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 1 12 2", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 1 X 2 2", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 1 !", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 1 aaa", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B zxc", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("1 2", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("V 1 2", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("X 1 2", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 1X1 2", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 3 4 4 4 4", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData(" B 3 4", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 3 4 ", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData(" B 3 4 ", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B11", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B -1 2", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 2 -1", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B -2 -4", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B -2 2", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
        [InlineData("B 1  2", new [] {"Please enter valid berry coordinates format. For example: 'B 1 2'"})]
